...
//                                     {cat.value === "konverthr_node" ? "Node.js" : "Odoo"}
//                                 </button>
//                             ))}
//                         </div>
...
//                                     <div className="w-2 h-2 rounded-full bg-[#FF3B8E]" />
//                                     <span className="text-xs font-black text-[#FF3B8E] uppercase tracking-widest">
//                                         KonvertHR Node.js APIs
//                                     </span>
//                                     <span className="text-[10px] font-black text-[#FF3B8E] px-2 py-0.5 rounded-full"
//                                         style={{ background: "rgba(255,59,142,0.15)" }}>
//                                         {nodeApis.length}
//                                     </span>
//                                 </div>
//                                 <div className="flex-1 h-px" style={{ background: "rgba(255,59,142,0.1)" }} />
//                             </div>

//                             {nodeApis.length === 0 ? (
//                                 <div className="text-center py-10 rounded-2xl"
//                                     style={{ border: "1px dashed rgba(255,59,142,0.15)" }}>
//                                     <p className="text-slate-600 text-sm">No Node.js APIs yet.</p>
//                                 </div>
//                             ) : (
...
//                                     <span className="text-xs font-black text-[#A78BFA] uppercase tracking-widest">
//                                         KonvertHR Odoo APIs
//                                     </span>
//                                     <span className="text-[10px] font-black text-[#A78BFA] px-2 py-0.5 rounded-full"
...
//                                     <p className="text-slate-600 text-sm">No Odoo APIs yet.</p>
//                                 </div>
//                             ) : (
//                                 <div className="space-y-2.5">
//                                     {odooApis.map((api) => (
...
export default function AdminPanel() {
    ...
    // ── Logout: localStorage clear + authChange event dispatch ──
    const handleLogout = () => {
        localStorage.removeItem("token");
        localStorage.removeItem("user");
