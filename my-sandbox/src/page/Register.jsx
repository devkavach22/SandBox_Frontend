        ...
        <div className="grid grid-cols-2 gap-1.5 p-3 rounded-xl mt-1"
            ...
            {reqs.map((r) => (
                <div key={r.label} className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] transition-colors" style={{ color: r.met ? "#FF3B8E" : "#374151" }}>
                        {r.label}
                    </span>
                </div>
            ))}
...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(e2).length > 0) { setErrors(e2); errorToast("Please fix the errors below."); return; }

        loadingToast("Creating your workspace...");
        try {
            await register({ name: form.name, email: form.email, password: form.password, confirm_password: form.confirm, phone: form.phone, avatar: avatar || null });
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                        ...
                        <div>
                            <label className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] block mb-2">
                                Profile Photo <span className="text-slate-700 normal-case font-normal tracking-normal">— optional</span>
                            </label>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    ...
                                    <input type="tel" name="phone" placeholder="10-digit number" value={form.phone}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                {errors.confirm
                                    ...
                                    : form.confirm && form.password === form.confirm
                                        ? <p className="text-[9px] text-[#FF3B8E] font-bold mt-1 flex items-center gap-1"><CheckCircle2 size={9} /> Match</p>
                                        : form.confirm
                                            ? <p className="text-[9px] text-red-400 mt-1 flex items-center gap-1"><X size={9} /> No match</p>
                                            : null
                                }
                            </div>
                        </div>
